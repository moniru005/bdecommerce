...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login | bdEcommerce</title>
      </Helmet>
      <div className=" my-16 flex flex-col justify-center items-center font-workSans">
        <div className="w-96  rounded-lg bg-gradient-to-tr from-[#C1DCDC] to-[#000] p-6">
          <div className="mb-8">
          ...
          <div className="">
            ...
            >
              ...
              <input
                className="p-4 border border-[#ffffff] bg-gradient-to-tr from-[#C1DCDC] to-[#000] hover:from-[#C1DCDC] text-white rounded-lg shadow-black shadow-xl hover:shadow-md cursor-pointer text-lg font-semibold"
                type="submit"
                value="Login"
              />
            </form>
